...
public class UIMainManager : MonoBehaviour
{
    ...
    private void OnGameStateChange(GameManager.eStateGame state)
    {
        switch (state)
        {
            case GameManager.eStateGame.MAIN_MENU:
                ShowMenu<UIPanelMain>(); break;
            case GameManager.eStateGame.GAME_STARTED:
                ShowMenu<UIPanelGame>(); break;
            case GameManager.eStateGame.PAUSE:
                ShowMenu<UIPanelPause>(); break;
            case GameManager.eStateGame.GAME_OVER:
                ShowMenu<UIPanelGameOver>(); break;
            case GameManager.eStateGame.GAME_WIN:
                ShowMenu<UIPanelGameWin>(); break;
            default: break;
        }
    }
    ...
    internal void LoadLevelMoves() => m_gameManager.LoadLevel(GameManager.eLevelMode.MOVES);
    internal void LoadLevelTimer() => m_gameManager.LoadLevel(GameManager.eLevelMode.TIMER);

    internal void LoadLevelTimeAttack() => m_gameManager.LoadLevelTimeAttack();
